...
<head>
  ...
  <body>
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-default navbar-fixed-top menu-animated" role="navigation">
        <div class="container">
            <div class="navbar-header page-scroll">
                ...
                <a class="page-scroll" href="#page-top"><img width="200px" height="auto" src="img/logo.png"/></a>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse pull-right">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="page-scroll" href="actu.php">Actualités</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="agenda.php">Agenda</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="espace_doc.php">Documents</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div id="page-top" class="jumbotron">
      <div class="container">
        ...
        <p><a class="btn btn-animated" href="#" role="button">Nos Articles &raquo;</a></p>
      </div>
    </div>
